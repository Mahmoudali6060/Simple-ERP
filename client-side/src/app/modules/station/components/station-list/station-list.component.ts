...
export class StationListComponent {
  ...
  result: string;
  total: number;
  constructor(public dialog: MatDialog, private router: Router, private stationService: StationService, private confirmationDialogService: ConfirmationDialogService) {
